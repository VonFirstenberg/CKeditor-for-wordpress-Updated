...
CKEDITOR.editorConfig = function(config) {
	...
	// Disable the "this version is not secure" nag notification introduced in 4.22.
	// This only silences the notice/HTTP check; it does not patch any underlying
	// vulnerabilities. See https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-versionCheck
