...
class add_ckeditor_button {
	...
	/**
	 * add_ckeditor_button::__construct()
	 * the constructor
	 *
	 * PHP 8+: PHP4-style constructors (methods matching the class name)
	 * are no longer recognized as constructors, so this must be
	 * __construct() to actually run.
	 *
	 * @return void
	 */
